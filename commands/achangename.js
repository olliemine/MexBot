...
module.exports = {
	...
	async execute(message, DiscordClient, args) {
		...
		if(user.roles.highest.position > message.guild.members.resolve(DiscordClient.user)) return message.channel.send({content: "Cant change name because role higher than bot."})
