...
module.exports = {
	...
	async execute(message, DiscordClient, args) {
		...
		if(member.roles.highest.position > server.members.resolve(DiscordClient.user)) return message.channel.send({content: "No se puede cambiar el nombre porque tiene role mayor."})
